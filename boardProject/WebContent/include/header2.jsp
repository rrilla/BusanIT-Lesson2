	...
	<div class="container">
		<nav class="navbar navbar-default">
			...
			<div class="navbar-header">
				...
				<!-- 로고 -->
				<img src="images/9pixel.gif" width="200" height="40">
				<!-- <img src="images/9pixel.gif" style="width:100%" /> -->
			</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>비번</label>
							<input type="text" id="mo_pw" class="form-control" placeholder="password">
						</div>
					</div>
...
$('#logout_a').on('click', function (event) {
	//return false;
	event.stopPropagation();    // 부모요소에 동일한 클릭 이벤트 전파를 막기
